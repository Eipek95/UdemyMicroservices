...
namespace FreeCourse.Services.Catalog.Services.CourseServices
{
    internal class CourseService : ICourseService
    {
        ...
        {
            //mongodb için join işlemleri olmadığı için manuel olarak course category sini manuel kodlamamız gerekiyor
            ...
            {
                courses = new List<Course> { };//yoksa boş bir liste oluşturup dön
            }
        ...
        public async Task<Response<NoContent>> UpdateAsync(CourseUpdateDto courseUpdateDto)
        {
            ...
            var result = await _courseCollection.FindOneAndReplaceAsync(x => x.Id == courseUpdateDto.Id, updateCourse);//önce var id den değeri bul sonra güncellenecek değerle değiştir
